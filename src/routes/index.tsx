...
import { Check, Copy, Sparkles, Smartphone, ArrowRight, ArrowUpRight } from "lucide-react";
...
function CommentGenerator() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <section id="generator" className="px-5 pt-20 pb-24">
      ...
      <footer className="px-5 py-8">
        <p className="mx-auto max-w-6xl text-sm text-muted-foreground">
          © {new Date().getFullYear()} GeeLark. Cloud phones for multi-account social growth.
        </p>
      </footer>
    </div>
  );
